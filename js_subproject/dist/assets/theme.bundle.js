...
var data = [{ theme: 'athletics',
    name: 'athletics',
    stories: [{ headline: 'A Northeastern Legend',
        ...
        quote: 'Like Jack, I strive to put Northeastern Men\'s Rowing and Northeastern University ahead of myself, and I have dedicated my collegiate career to try to make the team the best it has ever been.',
        quote_attr: 'Trevor Appier, BHS\'18',
        video: 'story_videos/trevor.mp4',
        link_to_page: 'Person85'
        ...
        quote: 'Fernie’s leadership established a tradition of hard work, good character, and athletic accomplishment. A strong hockey program provides yet another avenue for our students to achieve excellence.',
        quote_attr: 'James Madigan, DMSB\'86',
        video: 'story_videos/james_madigan.mp4',
        link_to_page: 'Person1366'
    ...
    stories: [{
        ...
        quote: 'Our goal is to give students a comprehensive toolkit for translating good intentions into effective, financially sustainable strategies for achieving social change.',
        quote_attr: 'Rebecca Riccio',
        video: 'story_videos/rebecca.mp4',
        link_to_page: 'Person1852'
    }, {
        ...
        quote: 'In 2013, Max became part of Northeastern University’s men’s basketball team. These players welcomed him as their teammate. His life changed — and so did theirs.',
        quote_attr: 'Michael Plansky, Max\'s father',
        video: 'story_videos/max_plansky.mp4',
        link_to_page: 'Person1761'
    }, {
    ...
    stories: [{
        ...
        quote: 'When I’m not out selling CoffeeBars, I’m still doing everything I can to stay involved around campus, supporting the next wave of student entrepreneurs at Northeastern.',
        quote_attr: 'Johnny Fayad, DMSB\'17',
        video: 'story_videos/EYC.mp4',
        link_to_page: 'NonPerson137'
    }, {
        ...
        quote: 'I stepped foot onto the Northeastern campus thinking that I would become a great engineer. However, because of Northeastern, I learned that I can also be an entrepreneur. Because of your gift, ScholarJet may one day change the world.',
        quote_attr: 'Tuan Ho, E\'18',
        video: 'story_videos/scholarjet.mp4',
        link_to_page: 'NonPerson353'
    }, {
        ...
        quote: 'Thank you for instilling in me a drive to empower those who did not win the \'lottery of life.\'',
        quote_attr: 'Mabel Gonzalez Nunez, DMSB\'20',
        video: 'story_videos/mabel.mp4',
        link_to_page: 'Person863'
    }]
}, { theme: 'faculty',
    name: 'faculty',
    stories: [{
        ...
        quote: 'It is an amazing honor to have the opportunity to lead the D’Amore-McKim School of Business.',
        quote_attr: 'Raj Echambadi',
        video: 'story_videos/raj.mp4',
        link_to_page: 'Person667'
    }, {
        ...
        quote: 'This generosity entirely transformed my research life, which aims to be a transformative force in world politics.',
        quote_attr: 'Denise Garcia',
        video: 'story_videos/denise.mp4',
        link_to_page: 'Person802'
    }, {
        ...
        quote: 'In business, there’s a long tradition of altruism toward the next generation.',
        quote_attr: 'Daniel McCarthy',
        video: 'story_videos/mccarthy.mp4',
        link_to_page: 'Person1435'
    }]
}, { theme: 'research',
    name: 'research',
    stories: [{
        ...
        quote: 'The work I did at KRI shaped my undergraduate experience. It informed my plans to work and study abroad, as well as my post-graduate professional and academic ambitions.',
        quote_attr: 'Connor Goddard, SSH\'14',
        video: 'story_videos/kostas.mp4',
        link_to_page: 'NonPerson212'
    }]
}, { theme: 'student',
    ...
    stories: [{
        ...
        quote: 'I wanted to pursue my law degree at a place where there was both camaraderie and opportunity for practical hands-on experience that would prepare me to practice in the real world. Working with Abbey through the IP CO-LAB was a highlight of my law school experience.',
        quote_attr: 'Kacy Cuenta, L\'17',
        video: 'story_videos/kacy.mp4',
        link_to_page: 'Person510'
    }, {
...
var theme = data.filter(function (d) {
    return d.theme === urlParams.theme;
});
...
if (theme.length > 0) {
    ...
    document.getElementById('story_visual').querySelector('a').setAttribute('href', 'single_node.html?id=' + story.link_to_page);
